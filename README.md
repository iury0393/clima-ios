...
An app that tells the weather of where you are or any city in the world.
...
<ul>
    <li>Swift</li>
    <li>Xcode</li>
    <li>OpenWeather Api - https://openweathermap.org/api</li>
</ul>

## Installation

```git
git clone https://github.com/iury0393/clima-ios
